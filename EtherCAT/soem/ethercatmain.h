...
struct ec_slavet_t;
struct ecx_contextt_t;


typedef int (*ecat_slave_init_t) (struct ecx_contextt_t *context, uint16 slave);//(int comp_id, struct ec_slavet_t *slave, ec_pdo_entry_reg_t *pdo_entry_regs);
typedef void (*ecat_slave_cleanup_t) (struct ec_slavet_t *slave);
typedef void (*ecat_slave_rw_t) (struct ecx_contextt_t *context, uint16 slave);
...
typedef struct ec_slavet_t
{
   ...
   ecat_slave_init_t proc_init;
   ecat_slave_cleanup_t proc_cleanup;
   ecat_slave_rw_t proc_read_write;
   ecat_slave_rw_t proc_write;
   void *hal_data;
   /** readable name */
